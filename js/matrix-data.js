...
window.DAOZHU_DATA = {
  ...
  milestones: [
    ...
    },
    {
      ...
      org: "好未来 / 学而思",
      desc: "在学而思（好未来）四年多历任不同核心团队：前期担任「学而思小猴」儿童动画编剧（团队 owner），统筹人设、世界观构建与全流程剧本规范；随后转入智能硬件团队，主导学习机世界观体系与「AI 小思」IP 从 0 到 1，落地大量 AI 智能体人设，建立可延展的 IP 应用规范；主导「摩比魔法七巧板」3–6 岁智能启蒙硬件全案：市场测算、竞品拆解、产品定义；从用户体验视角落地 3 款儿童互动游戏；跨 UI/UX/产品/研发协同推动上线。",
      tags: ["摩比魔法七巧板", "AI 小思 IP 规范", "学而思小猴动画"]
    },
    {
      step: "03",
  ...
  works: [
    {
      ...
      tag: "产品 · 0→1",
      title: "摩比魔法七巧板",
      role: "我的角色：产品负责人 · 市场测算 · 竞品拆解 · 商业与定价策略 · 版本节奏 · 六阶段增长",
