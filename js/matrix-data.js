...
window.DAOZHU_DATA = {
  profile: {
    ...
    socials: [
      ...
      { name: "站酷", handle: "daozhu", url: "https://www.zcool.com.cn/u/29262244" },
  ...
  satellites: [
    {
      ...
      image: null,
      posterOverlay: "十年一线影视与编剧实战 · 救猫咪重构与工业化手艺库",
    ...
    },
    {
      ...
      aspect: "aspect-square",
      image: null,
      desc: "“做再多商业与前沿 AI，心中始终留着一座小岛——留给童话、给女儿的画，和慢悠悠的时光。”坚持为女儿一一手绘成长绘本 30 册，沉淀原创 IP「芽芽兽」与 230 个思维模型知识库。",
  ...
  milestones: [
    ...
    {
      step: "02",
      period: "2021.12 – 2024.5",
      title: "创新产品策划 / 游戏编剧 · 学而思 智能硬件",
      sub: "INNOVATIVE PRODUCT & WORLDVIEW · 主导 AI 小思与摩比七巧板",
      org: "学而思 智能硬件",
      desc: "主导学习机世界观体系与「AI 小思」IP 从 0 到 1，落地大量 AI 智能体人设，建立可延展的 IP 应用规范；主导「摩比魔法七巧板」3–6 岁智能启蒙硬件全案：市场测算、竞品拆解、产品定义、799 元定价与约 80% 毛利模型、版本节奏（图像识别 90%→98%）；从用户体验视角落地 3 款儿童互动游戏；跨 UI/UX/产品/研发协同推动上线。",
      tags: ["摩比魔法七巧板", "799元定价 / 80%毛利", "AI 小思 IP 规范", "图像识别98%"]
    },
    {
      step: "03",
